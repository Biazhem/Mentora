...
export default function HomePage() {
  const features = [
    {
      title: "Job Portal",
      description: "Connect with top organizations and apply for roles that match your skills. Track your applications in real-time.",
    ...
    },
    {
      ...
      description: "High-performance task tracking for teams. Collaborate effectively with mentors and fellow students.",
    ...
    {
      title: "Mentorship",
      description: "Get guidance from experienced alumni and industry experts. Build relationships that last.",
    ...
    {
      title: "Events",
      description: "Stay updated with workshops, webinars, and networking events hosted by our community.",
    ...
    <div className="flex flex-col gap-12 py-8">
      ...
      <section className="relative overflow-hidden rounded-3xl bg-primary/5 p-8 md:p-16">
        <div className="relative z-10 max-w-3xl">
          ...
          <h1 className="mb-6 text-4xl font-extrabold tracking-tight md:text-6xl">
            Bridge the Gap Between <span className="text-primary">Learning</span> and <span className="text-primary">Earning</span>
          </h1>
          <p className="mb-8 text-lg text-muted-foreground md:text-xl">
            Mentora is the all-in-one platform for students, alumni, and organizations to collaborate, grow, and succeed together.
          </p>
      ...
      <section>
        <div className="mb-10 text-center">
          ...
          <p className="mt-2 text-muted-foreground">Four powerful pillars supporting your professional journey</p>
        </div>
      ...
      <section className="grid gap-8 md:grid-cols-3">
        <div className="flex items-center gap-4 rounded-xl border bg-card p-6">
          ...
          <div>
            ...
            <p className="text-sm text-muted-foreground">Active Tasks Completed</p>
          </div>
        </div>
        <div className="flex items-center gap-4 rounded-xl border bg-card p-6">
          <div className="rounded-full bg-primary/10 p-3">
      ...
      <section className="rounded-3xl bg-primary px-8 py-12 text-center text-primary-foreground">
        ...
        <p className="mx-auto mb-8 max-w-xl opacity-90">
          Join Mentora today and connect with mentors, discover job opportunities, and manage your tasks like a pro.
        </p>
